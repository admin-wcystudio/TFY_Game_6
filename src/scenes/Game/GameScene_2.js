...
export class GameScene_2 extends BaseGameScene {
    ...
    preload() {
        ...
        for (let i = 1; i <= 9; i++) {
            this.load.image(`game2_card${i}`, `${path}game2_card${i}.png`);
        }

        this.load.image(`game2_card_bg`, `${path}game2_card_bg.png`);
        this.load.image('game2_additions', `${path}game2_additions.png`);
    ...
    setupGameObjects() {
        ...
        this.add.image(centerX, centerY, 'game2_card_bg').setDepth(5);
        ...
        this.defaultCards = [
            { id: 1, content: 'game2_card1', targetX: centerX - 685, targetY: centerY, occupiedBy: null },
            { id: 2, content: 'game2_card2', targetX: centerX - 515, targetY: centerY, occupiedBy: null },
            { id: 3, content: 'game2_card3', targetX: centerX - 345, targetY: centerY, occupiedBy: null },
            { id: 4, content: 'game2_card4', targetX: centerX - 175, targetY: centerY, occupiedBy: null },
            { id: 5, content: 'game2_card5', targetX: centerX, targetY: centerY, occupiedBy: null },
            { id: 6, content: 'game2_card6', targetX: centerX + 175, targetY: centerY, occupiedBy: null },
            { id: 7, content: 'game2_card7', targetX: centerX + 345, targetY: centerY, occupiedBy: null },
            { id: 8, content: 'game2_card8', targetX: centerX + 515, targetY: centerY, occupiedBy: null },
            { id: 9, content: 'game2_card9', targetX: centerX + 685, targetY: centerY, occupiedBy: null }
        ];
    ...
    showWin() {
        ...
        this.addOnImg = this.add.image(960, 600, 'game2_additions')
    ...
    resetForNewRound() {
        ...
        this.confirm_button.setTexture('game2_confirm_button');
        this.isChecked = false;
